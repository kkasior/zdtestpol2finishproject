...
public class DevToTests {
    ...
    public void GoToWeekAndOpenFirstPost() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("crayons-article__header__meta"))); // poczekaj, aż element postu będzie widoczny, którego nie ma na stronie głównej
